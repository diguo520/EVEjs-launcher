...
export default {
  ...
  theme: {
  	...
  	extend: {
      /* __DS_BURN_START__ */
      fontFamily: { sans: ["Inter, \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", system-ui, sans-serif"], display: ["Inter, \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", system-ui, sans-serif"], mono: ["\"Roboto Mono\", \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", \"SF Mono\", ui-monospace, Menlo, monospace"] },
